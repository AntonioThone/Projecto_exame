...
public class SimularPartidaOP {
    ...
    public SimularPartidaOP(Conn conn) {
        try {
            this.connection = conn.getConnection();
            this.random = new Random();
            this.estatisticasIndividuaisOP = new EstatisticasIndividuaisOP(conn);
            this.partidaOP = new PartidaOP(conn);
        } catch (SQLException e) {
            e.printStackTrace();
        }
    }

    public void simularPartidasDoGrupo(int grupoId , Conn connection) throws SQLException {
        ...
        for (GrupoSelecao grupoSelecao : selecoes){
            System.out.println(selecoes.size());
            System.out.println("Equipe: " + grupoSelecao.getSelecaoId());
        }
    ...
    private void simularPartidaEntreSelecoes(Selecao selecaoCasa, Selecao selecaoFora, int grupoId , Conn connection) throws SQLException {
        ...
        System.out.print("Jogo a decorrer entre a op.Selecao " +
